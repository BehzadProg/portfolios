        ...
        <div class="row">
                ...
                <div class="row skills">
                    ...
                    <div class="col-sm-6">
                        <div class="bar_group wow fadeInUp" data-wow-delay="0.3s" data-max="100">
                            ...
                            <div class="bar_group__bar thick elastic" data-value="{{$item->percent}}" data-color="{{setColors($loop->index)}}"
            ...
            <div class="col-lg-6 d-none d-lg-block">
                <figure class="single-image text-right wow fadeInRight">
                    <img src="{{asset(env('SKILL_SETTING_IMAGE_UPLOAD_PATH').$skillSetting->image)}}" alt="">
                </figure>
            </div>
        </div>
    </div>
